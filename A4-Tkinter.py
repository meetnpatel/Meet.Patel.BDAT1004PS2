...
label_1 = Label(root1, text="Loan Amount:",width=20,font=("bold", 10))
label_1.grid(row=0, column=0)
entry_1 = Entry(root1)
entry_1.grid(row=0, column=1)
label_2 = Label(root1, text="Interest rate:",width=20,font=("bold", 10))
label_2.grid(row=1, column=0)
entry_2 = Entry(root1)
entry_2.grid(row=1, column=1)
label_3 = Label(root1, text="Loan terms:",width=20,font=("bold", 10))
